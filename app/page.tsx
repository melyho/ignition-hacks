    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-black">
      ...
      <main className="h-full w-full">
        {/* Hero Section */}
         <section
          id="ignition hacks"
          className="aspect-[16/9] w-screen flex items-center justify-center text-center overflow-hidden"
        >
          ...
          <div className="basis-[52%] h-full flex relative">
            ...
            >
              ...
              <div className="absolute bg-transparent w-[70%] aspect-[9/16] top-[2rem] left-[15%] border-[10px] border-[#7072BF] z-40 rounded-[20px] bg-gradient-to-r from-[#8d8fce] to-[#8A87D5]" />
        ...
        >
          ...
          <div className="relative  w-[90%] sm:w-[76.5%] aspect-[2.5/1] mt-[20vh] bg-[url('/Stats.svg')] bg-cover bg-center"></div>
        </section>
        ...
        >
          <div className="absolute md:bottom-0 w-full aspect-[1.4/1] bg-[url('/FAQ.svg')] bg-cover bg-bottom z-0"></div>
